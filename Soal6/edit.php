...
<!-- NAVBAR -->
  <nav class="navbar navbar-expand-sm navbar-light bg-light fixed-top bayang">
    <div class="container">
      <a class="navbar-brand" href="/arkademy-static/index.php"><img src="assets/img/arkademy-logo.png" width="8%"><span class="judul"><span style="color: #FF8FB2;">ARKADEMY</span> COFFEE SHOP</span></a>
    </div>
  </nav>
